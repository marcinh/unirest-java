...
public class Options {
	...
	public static void refresh() {
		...
		Object redirectEnabled = Options.getOption(Option.RECIRECT_ENABLED);
		if (redirectEnabled == null) redirectEnabled = true;
		...
		RequestConfig clientConfig = RequestConfig.custom()
			...
			.setRedirectsEnabled((Boolean) redirectEnabled)
			.setProxy(proxy)
			.build();
